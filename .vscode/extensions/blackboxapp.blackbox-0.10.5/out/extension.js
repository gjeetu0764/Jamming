...
function activate(_) {
				...
				thisWebview.webview.onDidReceiveMessage(
					async (data) => {
						...
						if (data.command) {
							...
							if (data.command =='search') openGettingStartedWebview()
								...
								addEnableAC(userId)
								open('https://www.youtube.com/watch?v=0ZyZRi2dZcs')
	...
	var panel = null
	function openGettingStartedWebview(force = false) {
		if (!panel) {
			...
			panel.webview.html = `
				...
				<html lang="en" style="margin: 0; padding: 0; min-width: 100%; min-height: 100%">
					...
					<body style="margin: 0; padding: 0; min-width: 100%; min-height: 100%">
						<iframe src="https://www.blackbx.ai/getstarted" id="config" frameborder="0" style="display: block; margin: 0; padding: 0; position: absolute; min-width: 100%; min-height: 100%; visibility: visible;"></iframe>
					</body>
				</html>`
		}
	}
